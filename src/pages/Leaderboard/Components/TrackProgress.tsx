                                    ...
                                    <table className="table border-2 border-amber-700 min-w-full">
                                        <thead className="min-w-full uppercase">
                                            <tr className="xl:text-lg md:text-base text-[15px] xl:py-5 lg:py-4 md:py-[14px] py-3 bg-amber-700 text-white flex items-center justify-between min-w-full">
                                                <th className='xl:px-10 lg:px-8 md:px-5 px-3 font-semibold md:w-[30%] w-[23%] text-left'>Rank</th>
                                                <th className='xl:px-10 lg:px-8 md:px-5 px-3 font-semibold md:w-[40%] w-[48%] text-left'>Name</th>
                                                <th className='xl:px-10 lg:px-8 md:px-5 px-3 font-semibold md:w-[30%] w-[27%] text-left'>Points</th>
                                            </tr>
                                        </thead >
                                        {
                                            data?.data?.map((user: any, index: number) =>
                                                <tbody key={user?._id}>
                                                    <tr className={`xl:py-3 lg:py-[10px] py-2 border-t-2 border-amber-700 flex items-center justify-between min-w-full ${index % 2 === 0 ? 'bg-amber-100' : ''
                                                        ...
                                                        <th className='xl:px-10 lg:px-8 md:px-5 px-3  md:w-[30%] w-[23%] xl:text-base lg:text-[13px] md:text-[13.5px] text-[13px] font-bold text-left'>{index + 1}</th>
                                                        ...
                                                        <th className='xl:px-10 lg:px-8 md:px-5 px-3 md:w-[30%] w-[27%] xl:text-base lg:text-[13px] md:text-[13.5px] text-[13px] font-medium text-left'>{user?.points}</th>
                                                    </tr>
                                                </tbody>
                                            )
                                        }
